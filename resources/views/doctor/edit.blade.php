...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Update  {{$doctor->name}} Doctor
        <small>Preview</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ route('department.home')}}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="{{route('doctor.create')}}">Craete New Doctor</a></li></ol>
    </section>
        ...
        <div class="col-lg-10">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Update {{$doctor->name}} Doctor</h3>
            </div>
            <!-- /.box-header -->
              ...
              <div class="box-body">
                                  ...
                                  class="form-control" 
                                      id="name" 
                                          placeholder="Enter Name Of Doctor"
                                            required value="{{$doctor->name}}" >
                </div>
                <div class="form-group">
                  <label for="about">About Doctor</label>
                  <textarea id="editor1" 
                              name="about" 
                                rows="10" cols="80" required>{{$doctor->about}}</textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="file" 
                            name="image" 
                              class="form-control" 
                                id="image" required value="{{$doctor->image}}" >
                </div>
