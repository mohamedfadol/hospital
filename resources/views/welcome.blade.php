...
<html lang="en">
  ...
  <body>
        ...
        <div class="container">
            <div class="row no-gutters d-flex align-items-start align-items-center px-3 px-md-0">
                <div class="col-lg-2 pr-4 align-items-center">
                    <a class="navbar-brand" href="{{route('forent.hospital.home')}}">{{$hospital->name}}</span></a>
                </div>
        ...
        <div class="container d-flex align-items-center">
          ...
          <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active"><a href="{{route('forent.hospital.home')}}" class="nav-link pl-0">Home</a></li>
                <li class="nav-item"><a href="{{route('forent.about.home')}}" class="nav-link">About</a></li>
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image:url({{URL::to('custom/images/bg_1.jpg')}});" data-stellar-background-ratio="0.5">
      ...
      <div class="slider-item" style="background-image:url({{URL::to('custom/images/bg_2.jpg')}});">
        <div class="overlay"></div>
        <div class="container">
          <div class="row no-gutters slider-text align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 text ftco-animate">
    ...
    <section class="ftco-services ftco-no-pb">
        ...
        <section class="ftco-intro" style="background-image: url({{URL::to('custom/images/bg_3.jpg')}});" data-stellar-background-ratio="0.5">
            <div class="overlay"></div>
            <div class="container">
                <div class="row">
                    <div class="col-md-9">
              ...
              <div class="col-md-12 tab-wrap">
                ...
                <div class="tab-content bg-light p-4 p-md-5 ftco-animate" id="v-pills-tabContent">
                  ...
                  <div class="tab-pane py-2 fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="day-1-tab">
                    <div class="row departments">
                        <div class="col-lg-4 order-lg-last d-flex align-items-stretch">
                            <div class="img d-flex align-self-stretch" style="background-image: url({{URL::to('custom/images/dept-1.jpg')}});"></div>
                        </div>
                        <div class="col-lg-8">
                  ...
                  <div class="tab-pane fade" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-day-2-tab">
                    <div class="row departments">
                        <div class="col-lg-4 order-lg-last d-flex align-items-stretch">
                            ...
                            style="background-image: url({{URL::to('custom/images/dept-2.jpg')}});"></div>
                        </div>
                        <div class="col-md-8">
                  ...
                  <div class="tab-pane fade" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-day-3-tab">
                    <div class="row departments">
                        <div class="col-lg-4 order-lg-last d-flex align-items-stretch">
                            <div class="img d-flex align-self-stretch" style="background-image: url({{URL::to('custom/images/dept-3.jpg')}});"></div>
                        </div>
                        <div class="col-md-8">
                  ...
                  <div class="tab-pane fade" id="v-pills-4" role="tabpanel" aria-labelledby="v-pills-day-4-tab">
                    <div class="row departments">
                        <div class="col-lg-4 order-lg-last d-flex align-items-stretch">
                            <div class="img d-flex align-self-stretch" 
                            style="background-image: url({{URL::to('custom/images/dept-4.jpg/')}});"></div>
                        </div>
                        <div class="col-md-8">
                  ...
                  <div class="tab-pane fade" id="v-pills-5" role="tabpanel" aria-labelledby="v-pills-day-5-tab">
                    <div class="row departments">
                        <div class="col-lg-4 order-lg-last d-flex align-items-stretch">
                            <div class="img d-flex align-self-stretch" 
                            style="background-image: url({{URL::to('custom/images/dept-5.jpg')}});"></div>
                        </div>
                        <div class="col-md-8">
                    ...
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="staff">
                            <div class="img-wrap d-flex align-items-stretch">
                                <img class="img align-self-stretch" src="/storage/cover_images/{{$doctor->image}}" />
                            </div>
    ...
    <section class="ftco-section ftco-no-pt ftco-no-pb ftco-counter img" id="section-counter" style="background-image: url({{URL::to('custom/images/bg_3.jpg')}});" data-stellar-background-ratio="0.5">
        <div class="container">
            <div class="row">
              ...
              <form action="{{route('customer.store')}}" method="POST" class="appointment-form ftco-animate" enctype="multipart/form-data">
                @csrf
                        <div class="d-md-flex">
                            <div class="form-group">
                                <input name="name" type="text" value="{{old('name')}}" class="form-control" placeholder="First Name" required>
                            </div>
                            <div class="form-group ml-md-4">
                                <input name="name2" value="{{old('name2')}}" type="text" class="form-control" placeholder="Last Name" required>
                            </div>
                        </div>
                        <div class="d-md-flex">
                            <div class="form-group">
                                <input name="email" value="{{old('email')}}" type="email" class="form-control" placeholder="Your E-mail" required>
                            </div>
                            <div class="form-group ml-md-4">
                                <input name="phone" value="{{old('phone')}}" type="text" class="form-control" placeholder="Your Phone" required>
                            </div>
                        </div>
                        <div class="d-md-flex">
                            <div class="form-group">
                      ...
                      <select name="department_id" id="DEPARTMENT" class="form-control" required>
                        ...
                        @if(count($departments) > 0)
                          ...
                          @endforeach
                        @else
                          <option value="" selected>Ther's No Department Fillable</option>
                        @endif
                      </select>
                    </div>
                      </div>
                      ...
                      <select name="doctor_id" id="DOCTOR" class="form-control" required>
                        <option value="DOCTOR">Select Your Doctor</option>
                        @if(count($doctotsle) > 0)
                          @foreach($doctotsle as $doctor)
                        ...
                        <div class="d-md-flex">
                            ...
                            <input type="text" value="{{old('attend')}}" name="attend" class="form-control appointment_date" placeholder="Date" required>
                        </div>
                            </div>
                            <div class="form-group ml-md-4">
                                <div class="input-wrap">
                            <div class="icon"><span class="ion-ios-clock"></span></div>
                            <input type="text" value="{{old('time')}}" name="time" class="form-control appointment_time" placeholder="Time" required>
                        </div>
                            </div>
                        </div>
                        <div class="d-md-flex">
                            <div class="form-group">
                      <textarea name="about" id="about" cols="30" rows="2" class="form-control" placeholder="Message" required>{{old('about')}}</textarea>
                    </div>
                    <div class="form-group ml-md-4">
                      <input type="file" name="image" required class="form-control btn btn-info">
                    </div>
                        </div>
                        <div class="d-md-flex">
                    <div class="form-group ml-md-4">
                ...
                <div class="col-lg-6 p-5 bg-counter aside-stretch">
                        <h3 class="vr">About {{$hospital->name}} Facts</h3>
                  ...
                  <div class="col-md-6 d-flex justify-content-center counter-wrap ftco-animate">
                    <div class="block-18 p-5 bg-light">
                      <div class="text">
                        <strong class="number" data-number="{{$doctors->count()}}"></strong>
        ...
        @foreach($blogs as $blog)
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="{{route('forent.blog.show',$blog->id)}}" class="block-20" 
              style="background-image: url('/storage/cover_images/{{$blog->image}}');">
              ...
              <div class="text bg-white p-4">
                ...
                <div class="d-flex align-items-center mt-4">
                    <p class="mb-0"><a href="{{route('forent.blog.show',$blog->id)}}" class="btn btn-primary">Read More <span class="ion-ios-arrow-round-forward"></span></a></p>
                    <p class="ml-auto mb-0">
                        <a href="#" class="mr-2">Posted</a>
                        <a href="#" class="meta-chat"><span class="icon-chat"></span> {{$comments->count()}}</a>
                    </p>
                </div>
              </div>
            </div>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-5">
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url({{URL::to('custom/images/image_1.jpg')}});"></a>
                <div class="text">
              ...
              <div class="block-21 mb-5 d-flex">
                <a class="blog-img mr-4" style="background-image: url({{URL::to('custom/images/image_2.jpg')}});"></a>
                <div class="text">
                  <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about</a></h3>
                  <div class="meta">
                    <div><a href="#"><span class="icon-calendar"></span> Dec 25, 2018</a></div>
          ...
          <div class="col-md">
            ...
            <div class="ftco-footer-widget mb-5">
              ...
              <form action="#" class="subscribe-form">
                <div class="form-group">
                  <input type="text" disabled class="form-control mb-2 text-center" placeholder="Enter email address">
                  <input type="submit" value="Subscribe" disabled class="form-control submit px-3">
                </div>
              </form>
            </div>
          </div>
