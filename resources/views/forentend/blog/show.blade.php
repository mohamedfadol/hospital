...
<html lang="en">
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active"><a href="{{route('forent.blog.home')}}" class="nav-link">News</a></li>
      ...
      <div class="container">
		...
		<section class="ftco-section">
          ...
          <div class="col-lg-8 ftco-animate">
            <h2 class="mb-3">#{{$new->id}}. {{$new->name}}</h2>
            <p>{{$new->about}}.</p>
            <p>
              <img src="/storage/cover_images/{{$new->image}}" alt="" class="img-fluid">
            </p>
            <p>{{$new->about}}.</p>
            ...
            <div class="about-author d-flex p-4 bg-light">
              <div class="bio mr-5">
                ...
                <img src="/storage/cover_images/{{$comment->image}}" alt="Image placeholder" class="img-fluid mb-4">
              </div>
              <div class="desc">
                <h3>{{$comment->name}}</h3>
                <p>{{$comment->about}}!</p>
            ...
            <div class="pt-2 mt-2">
              <h3 class="mb-5 h4 font-weight-bold">{{$comments->count()}}</h3>
              <ul class="comment-list">
              	@foreach($comments as $comment)
                <li class="comment">
                  <div class="vcard bio">
                    <img src="/storage/cover_images/{{$comment->image}}" alt="Image">
                  </div>
                  <div class="comment-body">
                    <h3>{{$comment->name}}</h3>
                    <p>{{$comment->about}}</p>
                    <div class="meta mb-2 float-right">{{$comment->created_at->diffForHumans()}}</div>
              ...
              <div class="comment-form-wrap pt-5">
		        ...
		        @if (count($errors) > 0)
		            ...
		            @endif
                <form action="{{route('comment.store')}}" method="POST" class="p-5 bg-light" enctype="multipart/form-data">
                	@csrf
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="job" class="form-control" id="email" placeholder="Your Job">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="about" id="message" placeholder="Your Comment" cols="30" rows="10" class="form-control"></textarea>
                  </div>
                  <div class="form-group">
          ...
          <div class="col-lg-4 sidebar ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url({{asset('custom/images/image_3.jpg')}});"></a>
                <div class="text">
                  <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                  <div class="meta">
                    <div><a href="#"><span class="icon-calendar"></span> Oct. 04, 2018</a></div>
  ...
  <script src="{{asset('custom')}}/https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
