    	...
    	<div class="container">
    		<div class="row no-gutters d-flex align-items-start align-items-center px-3 px-md-0">
    			<div class="col-lg-2 pr-4 align-items-center">
		    		<a class="navbar-brand" href="index.html"><span>{{$hospital->name}}</span></a>
	    		</div>
    ...
    @foreach($news as $new)
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="{{route('forent.blog.show',$new->id)}}" class="block-20" style="background-image: url('/storage/cover_images/{{$new->image}}');">

								<div class="meta-date text-center p-2">
                  <span class="day">{{$new->created_at->diffForHumans()}}</span>
                </div>
              </a>
              <div class="text bg-white p-4">
                ...
                <div class="d-flex align-items-center mt-4">
	                <p class="mb-0"><a href="{{route('forent.blog.show',$new->id)}}" class="btn btn-primary">Read More <span class="ion-ios-arrow-round-forward"></span></a></p>
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-5">
              <h2 class="ftco-heading-2 logo">{{$hospital->phone}}</h2>
