    	...
    	<div class="container">
    		<div class="row no-gutters d-flex align-items-start align-items-center px-3 px-md-0">
    			<div class="col-lg-2 pr-4 align-items-center">
		    		<a class="navbar-brand" href="{{route('forent.hospital.home')}}">{{$hospital->name}}</a>
	    		</div>
	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	...
	        	<li class="nav-item active"><a href="{{route('forent.department.home')}}" class="nav-link">Departments</a></li>
          ...
          <div class="col-md-8 text-center heading-section ftco-animate">
            ...
            <div class="col-md-12 nav-link-wrap">
	            <div class="nav nav-pills d-flex text-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
	              <a class="nav-link ftco-animate active mt-4" id="v-pills-1-tab" 
	              		data-toggle="pill" 
	              			href="#{{$department->id}}" 
	              				role="tab" aria-controls="v-pills-1" aria-selected="true">{{$department->name}}</a>
	          ...
	          <div class="col-md-12 tab-wrap">
	            ...
	            <div class="tab-content bg-light p-4 p-md-5 ftco-animate" id="v-pills-tabContent">
	              ...
	              <div class="tab-pane py-2 fade show active" id="{{$department->id}}" role="tabpanel" aria-labelledby="day-1-tab">
	              	<div class="row departments">
	              		<div class="col-lg-4 order-lg-last d-flex align-items-stretch">
	              			<img class="img d-flex align-self-stretch" src="/storage/cover_images/{{$department->image}}" />
	              		</div>
	              		<div class="col-lg-8">
	              			<h2>{{$department->name}} Deparments</h2>
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-5">
              <h2 class="ftco-heading-2 logo">{{$hospital->name}}</h2>
