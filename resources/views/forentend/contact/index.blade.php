...
<html lang="en">
  ...
  <body>
    ...
    <section class="ftco-section ftco-no-pt ftco-no-pb contact-section">
            ...
            @endif
						<form action="{{route('contacu.store')}}" method="POST">
              @csrf
      ...
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="col-md-3 d-flex">
          	<div class="bg-light d-flex align-self-stretch box p-4">
	            <p><span>Phone:</span> <a href="tel://1234567920">{{$hospital->phone}}</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="bg-light d-flex align-self-stretch box p-4">
	            <p><span>Email:</span> <a href="mailto:info@yoursite.com">{{$hospital->email}}</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="bg-light d-flex align-self-stretch box p-4">
	            <p><span>Website</span> <a href="#">{{$hospital->name}}</a></p>
	          </div>
          </div>
        </div>
      </div>
