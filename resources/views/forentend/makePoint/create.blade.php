      ...
      <div class="container d-flex align-items-center">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active"><a href="{{route('forent.contacu.home')}}" class="nav-link">Contact</a></li>
          </ul>
        </div>
      </div>
    </nav>
    ...
    <section class="ftco-section ftco-no-pt ftco-no-pb ftco-counter img" id="section-counter" style="background-image: url({{URL::to('custom/images/bg_3.jpg')}});" data-stellar-background-ratio="0.5">
        <div class="container">
            <div class="row">
              ...
              <form action="{{route('makePoint.store')}}" method="POST" class="appointment-form ftco-animate" enctype="multipart/form-data">
                @csrf
                        <div class="d-md-flex">
            ...
            <div class="ftco-footer-widget mb-5">
              ...
              <form action="#" class="subscribe-form">
                <div class="form-group">
                  ...
                  <input type="submit" disabled value="Subscribe" class="form-control submit px-3">
                </div>
              </form>
            </div>
          </div>
