	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	...
	        	<li class="nav-item active"><a href="{{route('forent.doctor.home')}}" class="nav-link">Doctor</a></li>
      ...
      <div class="container">
		...
		<section class="ftco-section">
			<div class="container">
				...
				@else
					<div class="alert alert-info text-center col-lg-12">Ther's No Data To Show </div>
				@endif
